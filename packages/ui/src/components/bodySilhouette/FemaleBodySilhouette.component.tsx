...
// NOTE: Human female anatomy. Each part path uses its own local coordinate
// origin; translate() transforms position them within the shared viewBox.

import type { KeyboardEvent } from 'react';
import type { BodySlotKey, SlotState } from './bodySilhouette.types';
import styles from './FemaleBodySilhouette.module.scss';

type Props = {
  slotStates: Partial<Record<BodySlotKey, SlotState>>;
  onSlotClick: (slot: BodySlotKey) => void;
  className?: string;
};

function zoneClass(state: SlotState | undefined): string {
  const base = styles.zone;
  if (state === 'active') return `${base} ${styles.zoneActive}`;
  if (state === 'filled') return `${base} ${styles.zoneFilled}`;
  return `${base} ${styles.zoneEmpty}`;
}

function makeKeyDown(slot: BodySlotKey, onSlotClick: (s: BodySlotKey) => void) {
...
export function FemaleBodySilhouette({ slotStates, onSlotClick, className }: Props) {
  return (
    <svg
      viewBox="-10 0 220 525"
      xmlns="http://www.w3.org/2000/svg"
      className={[styles.svg, className].filter(Boolean).join(' ')}
      role="img"
      aria-label="Equipped gear body diagram"
    >
      {/* â”€â”€ Head â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <g
        className={zoneClass(slotStates.head)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('head')}
        onKeyDown={makeKeyDown('head', onSlotClick)}
      ...
      {/* â”€â”€ Body (left-shoulder, right-shoulder, chest, stomach) â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <g
        className={zoneClass(slotStates.body)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('body')}
        onKeyDown={makeKeyDown('body', onSlotClick)}
        aria-label="Body slot"
      >
        {/* left shoulder */}
        <path
      ...
      {/* â”€â”€ Hands (left-arm, right-arm, left-hand, right-hand) â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <g
        className={zoneClass(slotStates.hands)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('hands')}
        onKeyDown={makeKeyDown('hands', onSlotClick)}
      ...
      <g
        className={zoneClass(slotStates.legs)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('legs')}
        onKeyDown={makeKeyDown('legs', onSlotClick)}
        aria-label="Legs slot"
      >
        {/* left leg */}
        <path
      ...
      {/* â”€â”€ Feet â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <g
        className={zoneClass(slotStates.feet)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('feet')}
        onKeyDown={makeKeyDown('feet', onSlotClick)}
        aria-label="Feet slot"
      >
        {/* left foot */}
        <path
          transform="translate(60, 465)"
      ...
      {/* â”€â”€ Weapon (left flank circle) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <g
        className={zoneClass(slotStates.weapon)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('weapon')}
        onKeyDown={makeKeyDown('weapon', onSlotClick)}
        aria-label="Weapon slot"
      >
        <circle cx="10" cy="245" r="13" />
      </g>

      {/* â”€â”€ Shield (right flank circle) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <g
        className={zoneClass(slotStates.shield)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('shield')}
        onKeyDown={makeKeyDown('shield', onSlotClick)}
        aria-label="Shield slot"
      >
        <circle cx="182" cy="245" r="13" />
      </g>

      {/* â”€â”€ Accessory (neck indicator) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <g
        className={zoneClass(slotStates.accessory)}
        role="button"
        tabIndex={0}
        onClick={() => onSlotClick('accessory')}
        onKeyDown={makeKeyDown('accessory', onSlotClick)}
        aria-label="Accessory slot"
      >
        <circle cx="100" cy="95" r="13" />
      </g>
    </svg>
  );
}
