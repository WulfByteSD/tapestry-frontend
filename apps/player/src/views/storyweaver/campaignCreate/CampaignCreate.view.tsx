...
export default function CampaignCreateView() {
  ...
  const apiError =
    (createCampaign.error as any)?.response?.data?.message || (createCampaign.error as any)?.response?.data?.error || (createCampaign.error as Error | null)?.message || '';
    ...
    <div className={styles.page}>
      <div className={styles.hero}>
        ...
        <p className={styles.subtitle}>
          Start with the table-facing bones: name, setting, tone dials, and content sources. Invites, join requests, and encounter tracking can layer in after this.
        </p>
      </div>
        ...
        <Card className={styles.formCard}>
          ...
          <CardBody>
            <form className={styles.form} onSubmit={handleSubmit}>
              <TextField label="Campaign Name" value={form.name} onChange={(e) => updateField('name', e.target.value)} error={errors.name} floatingLabel />
              ...
              <div className={styles.twoCol}>
                ...
                <SelectField label="Status" value={form.status} onChange={(e) => updateField('status', e.target.value as CampaignStatus)}>
