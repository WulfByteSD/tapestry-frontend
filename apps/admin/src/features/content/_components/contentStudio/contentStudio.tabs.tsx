...
export function createStudioTabs(props: {
  activeTab: TabKey;
  ...
  return [
    {
      ...
      label: "Lore",
      children:
        activeTab === "lore" ? <LoreView selectedSetting={selectedSetting} /> : <div style={{ minHeight: 640 }} />,
    },
    {
      key: "items",
      label: "Items",
      children:
        activeTab === "items" ? <ItemsView selectedSetting={selectedSetting} /> : <div style={{ minHeight: 640 }} />,
    },
    {
      key: "abilities",
      label: "Abilities",
      children:
        activeTab === "abilities" ? (
          <AbilitiesView selectedSetting={selectedSetting} />
        ) : (
    ...
    },
    {
      ...
      label: "Skills",
      children:
        activeTab === "skills" ? <SkillsView selectedSetting={selectedSetting} /> : <div style={{ minHeight: 640 }} />,
    },
  ];
}
